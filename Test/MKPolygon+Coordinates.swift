...
class MKPolygonCoordinatesTest: XCTestCase {
    ...
    func test__containsPointAt_legacy() {
        ...
        for coordinate in expectedCoordinates {
            expect(polygon.contains(pointAtCoordinates: coordinate)).to(beTrue())
        }
        
        for coordinate in unexpectedCoordinates {
            expect(polygon.contains(pointAtCoordinates: coordinate)).to(beFalse())
        }
